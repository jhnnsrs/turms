...
class MutationMeta(ModelMetaclass):
    """
    ...
    def __new__(mcls, name, bases, attrs):
        ...
        return super(MutationMeta, mcls).__new__(mcls, name, bases, attrs)
    ...
    def __init__(self, name, bases, attrs):
        super(MutationMeta, self).__init__(name, bases, attrs)
...
class GraphQLMutation(BaseModel, metaclass=MutationMeta):
    @classmethod
    def mutate(cls, variables):
        raise NotImplementedError()

    @classmethod
    async def amutate(cls, variables):
        raise NotImplementedError()
